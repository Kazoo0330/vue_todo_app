...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v3.5.3/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v3.5.3" } if s.respond_to? :metadata=
